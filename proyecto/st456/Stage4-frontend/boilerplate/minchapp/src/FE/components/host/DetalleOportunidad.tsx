...
import { FaCalendar, FaDollarSign, FaHome, FaPaw, FaHeart } from 'react-icons/fa';
  ...
  const handleExpresarInteres = async () => {
    if (id && token) {
      try {
        ...
        setMensaje('Te ha gustado esta oportunidad. El host será notificado.');
      } catch (error) {
        console.error('Error al dar like:', error);
        setMensaje('Hubo un error al dar like. Por favor, intenta de nuevo.');
      }
    }
  };
